...
for j=2:N-1
    ...
    if ubarra1 > 0
        if (phi(j+1)-phi(j-1))==0
            ...
            if cond>=0 && cond<=5/6
                aux1=phi(j-1)+(phi(j+1)-phi(j-1))*((6/8)*cond+3/8);
                aux1 = ubarra1*aux1;
            else
                if cond>5/6 && cond<=1
        ...
        if j==N-1
            ...
            if (phi(j)-phi(j+2))==0
                ...
                if cond>=0 && cond<=5/6
                    aux1=phi(j+2)+(phi(j)-phi(j+2))*((6/8)*cond+3/8);
                    aux1 = ubarra1*aux1;
                else
                    if cond>5/6 && cond<=1
                        aux1 = ubarra1*phi(j);                  
    ...
    if ubarra2 > 0
        if j==2
            ...
            if (phi(j)-phi(j-2))==0
                ...
                if cond>=0 && cond<=5/6
                    aux2=phi(j-2)+(phi(j)-phi(j-2))*((6/8)*cond+3/8);
                    aux2 = ubarra2*aux2;
                else
                    if cond>5/6 && cond<=1
                        aux2 = ubarra2*phi(j);                  
        ...
        if (phi(j-1)-phi(j+1))==0
            ...
            if cond>=0 && cond<=5/6
                aux2=phi(j+1)+(phi(j-1)-phi(j+1))*((6/8)*cond+3/8);
                aux2 = ubarra2*aux2;
            else
                if cond>5/6 && cond<=1
                    aux2 = ubarra2*phi(j-1);                  
