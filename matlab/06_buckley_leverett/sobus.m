function unew=sobus(u,dt,dx,tf,c)
        ...
        if (v>0)
            hU=u(j)^2/(u(j)^2+c*(1-u(j))^2);
                ...
                if ((hD-hR)==0)
                    ...
                    phiU=(hU-hR)/(hD-hR);
                    if phiU>=0 && phiU<=1
                        top1=hR+(hD-hR)*(-(sqrt(3)/2)*phiU+(1/2+sqrt(3)/3)*(-(1/2)*(3-sqrt(3))+3*sqrt((1/6)*(2-sqrt(3))+(sqrt(3)/3)*phiU)));
                    else
                        top1=hU;
                    end
                end         
        ...
        if (v>0)
            ...
            if (j>=3)
                ...
                if (hD-hR)==0
                    ...
                    phiU=(hU-hR)/(hD-hR);
                    if phiU>=0 && phiU<=1
                        top2=hR+(hD-hR)*(-(sqrt(3)/2)*phiU+(1/2+sqrt(3)/3)*(-(1/2)*(3-sqrt(3))+3*sqrt((1/6)*(2-sqrt(3))+(sqrt(3)/3)*phiU)));
                    else
                        top2=hU;
                    end
                end
